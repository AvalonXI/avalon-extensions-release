...
local ui = {
    ...
    -- Combo indices are 0-based; separate refs prevent stale indices after category changes.
    combos = {
        lo_main   = { 0 },
        lo_sub    = { 1 },   -- MNK; WAR/WAR fails on Apply.
        lo_tier   = { 0 },
        pr_cat    = { 0 },
        pr_job    = { 0 },
        pr_wtype  = { 0 },
...
local function draw_dev_panel()
    ...
    -- Ashita ignores flags when p_open is nil; keep this ref non-nil.
